...
export default function Hero() {
  const words = [
    ...
    " MERN Stack",
    "Learning Linux & GitHub for DevOps",
  ];

  const [code] = useState(`
const profile = {
  name: 'Hammad Dalvi',
  title: 'Aspiring Full-Stack Developer | Cloud & AI/ML Learner',
  skills: [
    'React', 'NextJS', 'Express',
    'MySQL', 'MongoDB', 'Git', 'Kali Linux'
  ],
  hardWorker: true,
  quickLearner: true,
  problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  "JavaScript Lover 🚀 | AI/ML & Web Development Enthusiast 💻 | Crafting Projects & Learning the Future ✨"
                </p>
              </div>

              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                <a
                  href="https://github.com/CodewithHammad08"
