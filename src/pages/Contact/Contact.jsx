...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://formspree.io/f/mpwyyvkz", {
        method: "POST",
        body: form,
      ...
      if (response.ok) {
        ...
        setStatus(result.error || "There was an error sending your message.");
      }
    } catch (error) {
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">hammaddalvi08@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">CodewithHammad08</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="bg-cyan-500/10 p-3 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Hammad Dalvi</p>
                  </div>
                </div>
